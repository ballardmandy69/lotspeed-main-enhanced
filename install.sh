#!/usr/bin/env bash
#
# LotSpeed v3.10.2 enhanced installer
...
validate_built_module() {
    ...
    info "Validated module ${built_version} and v3.10.2 parameter set."
}
